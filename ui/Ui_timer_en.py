...
# Form implementation generated from reading ui file 'E:\workspace\UpSite\ui\timer_en.ui'
#
...
class Ui_calibrationClockDialog(object):
    ...
    def retranslateUi(self, calibrationClockDialog):
        calibrationClockDialog.setWindowTitle(_translate("calibrationClockDialog", "Clock", None))
        ...
        self.label.setText(_translate("calibrationClockDialog", "Clock", None))
        self.downSiteTime.setDisplayFormat(_translate("calibrationClockDialog", "yyyy/MM/dd HH:mm:ss", None))
        self.label_2.setText(_translate("calibrationClockDialog", "Device Clock", None))
