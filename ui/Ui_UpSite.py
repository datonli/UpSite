...
class Ui_CTH(object):
    ...
    def retranslateUi(self, CTH):
        ...
        self.updatePara.setText(_translate("CTH", "更改参数", None))
        self.label_7.setText(_translate("CTH", "仪器编号", None))
        self.handComboBox.setItemText(0, _translate("CTH", "立即", None))
        self.handComboBox.setItemText(1, _translate("CTH", "手动", None))
        self.sampleInvBox.setItemText(0, _translate("CTH", "秒", None))
        self.sampleInvBox.setItemText(1, _translate("CTH", "分", None))
        self.sampleInvBox.setItemText(2, _translate("CTH", "时", None))
        self.refreshPara.setText(_translate("CTH", "刷新", None))
        self.calibrationClockButton.setText(_translate("CTH", "校准时钟", None))
        self.label_12.setText(_translate("CTH", "二氧化碳报警值", None))
        self.label_14.setText(_translate("CTH", "立即/手动", None))
        self.label_11.setText(_translate("CTH", "采样间隔", None))
        self.label_10.setText(_translate("CTH", "记录次数", None))
        self.label_8.setText(_translate("CTH", "测量名称", None))
        self.stopRecord.setText(_translate("CTH", "停止记录", None))
        self.label_9.setText(_translate("CTH", "摄氏度(℃)", None))
        self.label_6.setText(_translate("CTH", "华氏度(℉)", None))
        self.label_5.setText(_translate("CTH", "湿度(%)", None))
        self.label_4.setText(_translate("CTH", "二氧化碳浓度(PPM)", None))
        self.label_13.setText(_translate("CTH", "大气压(hPa)", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.baseTab), _translate("CTH", "基本信息", None))
        self.deleteFileButton.setText(_translate("CTH", "删除文件", None))
        self.refreshFiles.setText(_translate("CTH", "刷新", None))
        self.receiveFiles.setText(_translate("CTH", "接收文件", None))
        item = self.fileOperTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("CTH", "文件名", None))
        item = self.fileOperTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("CTH", "文件大小", None))
        item = self.fileOperTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("CTH", "更新时间", None))
        self.tranferFileButton.setText(_translate("CTH", "转换文件", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("CTH", "文件操作", None))
        self.recordrangeBox.setTitle(_translate("CTH", "记录查询范围", None))
        self.queryButton.setText(_translate("CTH", "开始查询", None))
        self.label_2.setText(_translate("CTH", "天", None))
        self.radioButton.setText(_translate("CTH", "从", None))
        self.label.setText(_translate("CTH", "   到", None))
        self.alldateRadioButton.setText(_translate("CTH", "所有日期", None))
        self.beforedayRadioButton.setText(_translate("CTH", "前", None))
        self.beforeMonthRadioButton.setText(_translate("CTH", "前", None))
        self.label_3.setText(_translate("CTH", "月", None))
        item = self.displayDetailInfoTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("CTH", "时间", None))
        item = self.displayDetailInfoTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("CTH", "二氧化碳浓度", None))
        item = self.displayDetailInfoTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("CTH", "温度", None))
        item = self.displayDetailInfoTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("CTH", "湿度", None))
        item = self.displayDetailInfoTableWidget.horizontalHeaderItem(4)
        item.setText(_translate("CTH", "大气压", None))
        item = self.displayDetailInfoTableWidget.horizontalHeaderItem(5)
        item.setText(_translate("CTH", "电池电压", None))
        self.fileOperBox.setTitle(_translate("CTH", "文件管理", None))
        self.loadinFileButton.setText(_translate("CTH", "导入文件", None))
        self.groupBox.setTitle(_translate("CTH", "曲线图", None))
        self.tempCheckBox.setText(_translate("CTH", "温度", None))
        self.co2CheckBox.setText(_translate("CTH", "二氧化碳浓度", None))
        self.humiCheckBox.setText(_translate("CTH", "湿度", None))
        self.atmospheriCheckBox.setText(_translate("CTH", "大气压", None))
        self.batteryCheckBox.setText(_translate("CTH", "电池电压", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.recordTab), _translate("CTH", "记录查询", None))
        self.fileMenu.setTitle(_translate("CTH", "文件", None))
        self.helpMenu.setTitle(_translate("CTH", "帮助", None))
        self.openAct.setText(_translate("CTH", "打开", None))
        self.loadAct.setText(_translate("CTH", "导入", None))
        self.exitAct.setText(_translate("CTH", "退出", None))
        ...
        self.helpAct.setText(_translate("CTH", "操作说明", None))
        self.aboutAct.setText(_translate("CTH", "关于", None))
