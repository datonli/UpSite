...
# Form implementation generated from reading ui file 'E:\workspace\UpSite\ui\ReturnInfo.ui'
#
...
class Ui_returnInfoDialog(object):
    def setupUi(self, returnInfoDialog):
        ...
        self.okButton.setGeometry(QtCore.QRect(150, 230, 75, 23))
    ...
    def retranslateUi(self, returnInfoDialog):
        returnInfoDialog.setWindowTitle(_translate("returnInfoDialog", "提示信息", None))
        self.okButton.setText(_translate("returnInfoDialog", "确定", None))
